...
@Component({
  selector: 'app-fypage',
  templateUrl: './fypage.component.html',
  styleUrls: ['./fypage.component.css']
})
export class FYPageComponent implements OnInit {
  ...
  onSubmit(data){
    ...
    return this.http.post("https://crunchbase-gradify.herokuapp.com/sample/",data.value).subscribe((result)=>{
